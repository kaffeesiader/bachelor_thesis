...
States the connection to a Schunk hand model. The only additional parts that have to be discovered during initialization are the 7 gripper joints and their corresponding names. The available tags are
listed in Table\ref{fig:schunk_tags}
\begin{table}[h]
  \centering
